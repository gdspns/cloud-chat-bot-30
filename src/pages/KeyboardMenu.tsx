...
// --- Bot Description Panel ---
function BotDescriptionPanel({
  isConnected,
  callApi,
  showToast,
  syncConfigToCloud,
  ...
  if (!isConnected) {
    return (
      <div className="max-w-3xl mx-auto">
        <div className="bg-card p-6 rounded-xl border shadow-sm text-sm text-muted-foreground">
          请先在「ID 连接&重置」中连接机器人后，再设置机器人介绍。
        </div>
      </div>
    );
  }
