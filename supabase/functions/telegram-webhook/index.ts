...
const shopI18n: Record<string, { zh: string; en: string }> = {
  ...
  physical_address_received: { zh: "✅ 收货地址已记录，等待管理员处理发货\n\n📬 管理员发货后，您将收到发货通知（含快递公司及快递单号）", en: "✅ Shipping address recorded, waiting for admin to process\n\n📬 You will receive a shipping notification (with courier and tracking number) once shipped" },
